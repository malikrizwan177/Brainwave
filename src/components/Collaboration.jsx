          ...
          <div className="relative left-1/2 flex w-[20rem] aspect-square border border-n-6 rounded-full -translate-x-1/2 scale:75 md:scale-100">
            ...
            <ul>
              {collabApps.map((app, index) => (
                ...
                >
                  <div
                    className={`relative -top-[1.6rem] flex w-[3.2rem] h-[3.2rem] hover:-translate-y-2 hover:scale-110 ease-in-out duration-300 bg-n-7 hover:bg-n-6 border border-n-1/15 rounded-xl -rotate-${
                      index * 45
                    }`}
                  >
                    <img
